...
def _role_to_response(role: Role) -> RoleResponse:
    return RoleResponse(
        ...
        required_skills=safe_json_loads(role.required_skills),
        preferred_skills=safe_json_loads(role.preferred_skills),
    ...
    for ct, to_role in rows:
        transitions.append(
            TransitionResponse(
                ...
                required_upskills=safe_json_loads(ct.required_upskills),
